        ...
        <section class="hero">
            <div class="slideshow-container">
                <div class="slide fade">
                    <div class="slide-img" style="background-image: url('{{ asset('assets/bg1.jpg') }}');"></div>
                </div>
                <div class="slide fade">
                    <div class="slide-img" style="background-image: url('{{ asset('assets/bg2.jpg') }}');"></div>
                </div>
                <div class="slide fade">
                    <div class="slide-img" style="background-image: url('{{ asset('assets/bg3.jpg') }}');"></div>
                </div>
            </div>
